...
const zhCN: Record<string, string> = {
  ...
  "director.exportExisting": "导出已有结果（{count}）",
  "director.exportExistingHint": "导出所选片段现有的成片，但不会把它们标记为最新。",
  "director.exportExistingConfirm": "所选片段中有 {count} 段不再符合当前项目设置。将导出它们已有的成片，并保留“需要重新生成”状态。确定继续吗？",
